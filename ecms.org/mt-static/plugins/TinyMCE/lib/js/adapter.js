...
;(function($) {
    ...
    $.extend(MT.Editor.TinyMCE, MT.Editor, {
        ...
        config: {
            ...
            resize: true,
            style_formats: [
                {title: '太字', inline: 'strong'},
                {title: '赤文字', inline: 'em'},
                {title: '中央寄せ', block: 'p', classes: 'u-center'},
                {title: '右寄せ', block: 'p', classes: 'u-right'},
                {title: '左寄せ', block: 'p', classes: 'u-left'},
                {title: '上付き文字', inline: 'sup'},
                {title: '下付き文字', inline: 'sub'}
            ],
            ...
            plugin_mt_wysiwyg_buttons1:'bold,strikethrough,|,bullist,numlist,hr,|,link,unlink,|,mt_insert_html,mt_insert_file,mt_insert_image',
            plugin_mt_wysiwyg_buttons2:'undo,redo,|,removeformat,|,justifyleft,justifycenter,justifyright,indent,outdent,|,mt_fullscreen|,styleselect',
